  ...
  ({ int __sio(var)(phx_is_ok) = 0; \
    ...
    if (__sio(m)(assert)(__sio(m)(type_enforce)(__sio(var)(_a), \
      ...
      if (__sio(m)(smin)(__sio(var)(_a)) <= ((typeof(__sio(var)(_a)))0)) { \
        __sio(var)(phx_is_ok) = safe_sadd(__sio(var)(p), \
                                   __sio(var)(_a), \
                                   __sio(var)(_b)); \
      } else { \
        __sio(var)(phx_is_ok) = safe_uadd(__sio(var)(p), \
                                   __sio(var)(_a), \
                                   __sio(var)(_b)); \
      } \
    } \
  ...
  ({ int __sio(var)(phx_is_ok) = 0; \
    ...
    if (__sio(m)(assert)(__sio(m)(type_enforce)(__sio(var)(_a), \
      ...
      if (__sio(m)(umax)(__sio(var)(_a)) <= ((typeof(__sio(var)(_a)))0)) { \
        __sio(var)(phx_is_ok) = safe_ssub(__sio(var)(p), \
                                   __sio(var)(_a), \
                                   __sio(var)(_b)); \
      } else { \
        __sio(var)(phx_is_ok) = safe_usub(__sio(var)(p), \
                                   __sio(var)(_a), \
                                   __sio(var)(_b)); \
      } \
    } \
...
#define safe_mul(_ptr, __a, __b) \
  ({ int __sio(var)(phx_is_ok) = 0; \
    ...
    if (__sio(m)(assert)(__sio(m)(type_enforce)(__sio(var)(_a), \
                         __sio(var)(_b)))) { \
      if (__sio(m)(umax)(__sio(var)(_a)) <= ((typeof(__sio(var)(_a)))0)) { \
        __sio(var)(phx_is_ok) = safe_smul(__sio(var)(p), \
                                   __sio(var)(_a), \
                                   __sio(var)(_b)); \
      } else { \
        __sio(var)(phx_is_ok) = safe_umul(__sio(var)(p), \
                                   __sio(var)(_a), \
                                   __sio(var)(_b)); \
      } \
    } \
...
#define safe_div(_ptr, __a, __b) \
  ({ int __sio(var)(phx_is_ok) = 0; \
    ...
    if (__sio(m)(assert)(__sio(m)(type_enforce)(__sio(var)(_a), \
                         __sio(var)(_b)))) { \
      if (__sio(m)(umax)(__sio(var)(_a)) <= ((typeof(__sio(var)(_a)))0)) { \
        __sio(var)(phx_is_ok) = safe_sdiv(__sio(var)(p), \
                                   __sio(var)(_a), \
                                   __sio(var)(_b)); \
      } else { \
        __sio(var)(phx_is_ok) = safe_udiv(__sio(var)(p), \
                                   __sio(var)(_a), \
                                   __sio(var)(_b)); \
      } \
    } \
...
#define safe_mod(_ptr, __a, __b) \
  ({ int __sio(var)(phx_is_ok) = 0; \
    ...
    if (__sio(m)(assert)(__sio(m)(type_enforce)(__sio(var)(_a), \
                         __sio(var)(_b)))) { \
      if (__sio(m)(umax)(__sio(var)(_a)) <= ((typeof(__sio(var)(_a)))0)) { \
        __sio(var)(phx_is_ok) = safe_smod(__sio(var)(p), \
                                   __sio(var)(_a), \
                                   __sio(var)(_b)); \
      } else { \
        __sio(var)(phx_is_ok) = safe_umod(__sio(var)(p), \
                                   __sio(var)(_a), \
                                   __sio(var)(_b)); \
      } \
    } \
...
#define safe_uadd(_ptr, _a, _b) \
  ({ int __sio(var)(phx_var_ok) = 0; \
    if ((typeof(_a))(_b) <= (typeof(_a))(__sio(m)(umax)(_a) - (_a))) { \
      if ((_ptr)) { *((typeof(_a)*)(_ptr)) = (_a) + (_b); } \
      __sio(var)(phx_var_ok) = 1; \
    } __sio(var)(phx_var_ok); })

#define safe_sadd(_ptr, _a, _b) \
  ({ int __sio(var)(phx_ok) = 1; \
    if (((_b) > (typeof(_a))0) && ((_a) > (typeof(_a))0)) { /*>0*/ \
      if ((_a) > (typeof(_a))(__sio(m)(smax)(_a) - (_b))) __sio(var)(phx_ok) = 0; \
    } else if (!((_b) > (typeof(_a))0) && !((_a) > (typeof(_a))0)) { /*<0*/ \
      if ((_a) < (typeof(_a))(__sio(m)(smin)(_a) - (_b))) __sio(var)(phx_ok) = 0; \
    } \
    if (__sio(var)(phx_ok) && (_ptr)) { *((typeof(_a)*)(_ptr)) = (_a) + (_b); } \
    __sio(var)(phx_ok); })
...
#define safe_smul(_ptr, _a, _b) \
  ({ int __sio(var)(phx_is_ok) = 1; \
    ...
    if (__sio(var)(phx_is_ok) && (_ptr)) { *((typeof(_a)*)(_ptr)) = (_a) * (_b); } \
    __sio(var)(phx_is_ok); })
