...
struct _LIBAROMA_WM{
  ...
  LIBAROMA_WMCB_UI_THREAD message_thread_handler;
  LIBAROMA_WMCB_UI_THREAD deviceinfo_thread_handler;
  LIBAROMA_WMCB_UI_THREAD power_menu_window;
...
/*
 * Function    : libaroma_wm_set_message_thread_handler
 * Return Value: byte
 * Descriptions: set message thread handler
 */
...
/*
 * Function    : libaroma_wm_set_power_menu_window_handler
 * Return Value: byte
 * Descriptions: set power menu thread handler
 */
