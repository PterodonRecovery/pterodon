...
#define LIBAROMA_MSG_WIN_POWERMENU        LIBAROMA_MSG_SYS(0x10)
#define LIBAROMA_MSG_WIN_BUSY        LIBAROMA_MSG_SYS(0x11)
...
typedef void (*LIBAROMA_WINDOW_INIT_HANDLER) \
  (LIBAROMA_WINDOWP);
...
/*
 * Function    : libaroma_window_set_initializer
 * Return Value: void
 * Descriptions: set window initializer
 */
void libaroma_window_set_initializer(
    LIBAROMA_WINDOW_INIT_HANDLER callback
);
