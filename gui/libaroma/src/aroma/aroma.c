...
byte libaroma_start_basic() {
if (!libaroma_fb_init()) {
    ALOGE("cannot init framebuffer");
    return 0;
  }
  return 1;
}

void libaroma_set_font_size(byte size) {
libaroma_font_set_size(0, libaroma_font_size_px(size), 0);
}
...
// }
  ...
  ALOGI("=================== INITIALIZED MESSAGE QUEUE =================== ");
  ...
  ALOGI("=================== INITIALIZED LANGUAGE ENGINE =================== ");
  ...
  ALOGI("=================== INITIALIZED TIMER ENGINE =================== ");
  ...
  ALOGI("=================== INITIALIZED WINDOW MANAGER =================== ");
